...
<html lang="it">
	...
	<div id="testata">
		...
		<div class="colonna2">Benvenuto su {$title}
            ...
            <div class="riga2">
                <div class="colonna1"><IMG alt="{$title} - {$slogan}" src="img/guestbook.png" width="256px">
		</div>
		<div class="colonna2">
        ...
        <div id='down'>
            <strong>&copy;2022 {$copy}</strong> - Tutti i diritti sono riservati <small>(eXperience GuestBook Ver.: {$ver}) - Pagina generata in {$time} secondi.</small>
            <br>
        </div>
